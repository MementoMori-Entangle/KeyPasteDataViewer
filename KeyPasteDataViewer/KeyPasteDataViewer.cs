...
namespace KeyPasteDataViewer
{
    ...
    /// キー貼り付けデータビュア
    /// </summary>
    public partial class KeyPasteDataViewer : Form
    {
        /// <summary>
        /// キー貼り付けデータ
        /// </summary>
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void UseConnection1Button_Click(object sender, EventArgs e)
        {
            try
            {
                this.UseConnection((string)Properties.Settings.Default[KeyPasteData.KEY_USE_CONNECTION_1]);
                this.Connection();
            }
            catch (Exception ex)
            {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void UseConnection2Button_Click(object sender, EventArgs e)
        {
            try
            {
                this.UseConnection((string)Properties.Settings.Default[KeyPasteData.KEY_USE_CONNECTION_2]);
                this.Connection();
            }
            catch (Exception ex)
            {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void UseConnection3Button_Click(object sender, EventArgs e)
        {
            try
            {
                this.UseConnection((string)Properties.Settings.Default[KeyPasteData.KEY_USE_CONNECTION_3]);
                this.Connection();
            }
            catch (Exception ex)
            {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void UseConnection4Button_Click(object sender, EventArgs e)
        {
            try
            {
                this.UseConnection((string)Properties.Settings.Default[KeyPasteData.KEY_USE_CONNECTION_4]);
                this.Connection();
            }
            catch (Exception ex)
            {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void UseConnection5Button_Click(object sender, EventArgs e)
        {
            try
            {
                this.UseConnection((string)Properties.Settings.Default[KeyPasteData.KEY_USE_CONNECTION_5]);
                this.Connection();
            }
            catch (Exception ex)
            {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void UseConnectionSave1Button_Click(object sender, EventArgs e)
        {
            this.ConnectionInfoSave();
            Properties.Settings.Default[KeyPasteData.KEY_USE_CONNECTION_1] = this.GetUseConnection();
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void UseConnectionSave2Button_Click(object sender, EventArgs e)
        {
            this.ConnectionInfoSave();
            Properties.Settings.Default[KeyPasteData.KEY_USE_CONNECTION_2] = this.GetUseConnection();
            Properties.Settings.Default.Save();
        }
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void UseConnectionSave3Button_Click(object sender, EventArgs e)
        {
            this.ConnectionInfoSave();
            Properties.Settings.Default[KeyPasteData.KEY_USE_CONNECTION_3] = this.GetUseConnection();
            Properties.Settings.Default.Save();
        }
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void UseConnectionSave4Button_Click(object sender, EventArgs e)
        {
            this.ConnectionInfoSave();
            Properties.Settings.Default[KeyPasteData.KEY_USE_CONNECTION_4] = this.GetUseConnection();
            Properties.Settings.Default.Save();
        }
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void UseConnectionSave5Button_Click(object sender, EventArgs e)
        {
            this.ConnectionInfoSave();
            Properties.Settings.Default[KeyPasteData.KEY_USE_CONNECTION_5] = this.GetUseConnection();
            Properties.Settings.Default.Save();
        }
            ...
            try
            {
                switch (this.keyPasteData.DataType)
                {
                    ...
                    case KeyPasteData.DATA_TYPE_POSTGRESQL:
                        ...
                        this.keyPasteData.ConnectionString = KeyPasteData.CONNECTION_POSTGRESQL_DATA_SOURCE + this.keyPasteData.DataSource + port
                                              + KeyPasteData.CONNECTION_POSTGRESQL_CATALOG + this.keyPasteData.Catalog + KeyPasteData.CONNECTION_POSTGRESQL_USER + this.keyPasteData.User
                                              + KeyPasteData.CONNECTION_POSTGRESQL_PASSWORD + this.keyPasteData.Password + KeyPasteData.CONNECTION_POSTGRESQL_SECURITY;
                        isConnection = this.keyPasteData.IsDataBaseConnection();
                        if (isConnection)
                        {
                            dataList = this.keyPasteData.GetTableInfo(KeyPasteData.DB_POSTGRESQL_TABLE_NAME_QUERY, this.keyPasteData.Catalog);
                        }
                        break;
                    case KeyPasteData.DATA_TYPE_ORACLE:
                        if (!string.IsNullOrEmpty(port))
                        ...
                        this.keyPasteData.ConnectionString = KeyPasteData.CONNECTION_ORACLE_USER + this.keyPasteData.User
                                              + KeyPasteData.CONNECTION_ORACLE_PASSWORD + this.keyPasteData.Password + KeyPasteData.CONNECTION_ORACLE_DATA_SOURCE
                                              + this.keyPasteData.DataSource + port + KeyPasteData.CONNECTION_ORACLE_SERVICE + this.keyPasteData.Catalog;
                        isConnection = this.keyPasteData.IsDataBaseConnection();
                        if (isConnection)
                        {
                            dataList = this.keyPasteData.GetTableInfo(KeyPasteData.DB_ORACLE_TABLE_NAME_QUERY, this.keyPasteData.Catalog);
                        }
                        break;
                    case KeyPasteData.DATA_TYPE_EXCEL:
        ...
        private void LoadSetting()
        {
            ...
            UseConnection1Button.Text = (string)Properties.Settings.Default[KeyPasteData.KEY_USE_CONNECTION_NAME_1];
            UseConnection2Button.Text = (string)Properties.Settings.Default[KeyPasteData.KEY_USE_CONNECTION_NAME_2];
